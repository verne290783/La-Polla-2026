...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-neutral-950 pb-24 md:pb-8 flex flex-col">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-30 bg-neutral-950/95 border-t border-neutral-900 backdrop-blur-md px-2 py-2 flex items-center justify-around">
        {tabs.map(tab => (
          <button
            key={tab.id}
            onClick={() => setActiveTab(tab.id)}
